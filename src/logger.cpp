...
namespace Object{
    ...
    void __log_func(const char* file, int line, LogLevel level, const char* fmt, ...) {
        ...
        if (level == LogLevel::Fatal) {
            __android_log_print(ANDROID_LOG_FATAL, "Object", "%s", buffer);
        }
        else if(level == LogLevel::Error){
            __android_log_print(ANDROID_LOG_ERROR, "Object", "%s", buffer);
        }
        else if (level == LogLevel::Warning) {
            __android_log_print(ANDROID_LOG_WARN, "Object", "%s", buffer);
        }
        else {
            __android_log_print(ANDROID_LOG_INFO, "Object", "%s", buffer);
        }
    #else
