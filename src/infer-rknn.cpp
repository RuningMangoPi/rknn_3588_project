...
namespace rknn {
    ...
    bool InferImpl::load_from_memory(const void* pdata, size_t size, bool sync_mode) {
        ...
        if(!checkRKNN(::rknn_init(&rknn_handle_, (void*)pdata, size, flags, NULL))){
    ...
    static Object::DataType convert_trt_datatype(rknn_tensor_type dt){
        switch(dt){
            case rknn_tensor_type::RKNN_TENSOR_FLOAT32: return Object::DataType::Float;
            case rknn_tensor_type::RKNN_TENSOR_FLOAT16: return Object::DataType::Float16;
            case rknn_tensor_type::RKNN_TENSOR_UINT8: return Object::DataType::UInt8;
            default:
                INFOE("Unsupport data type %d", dt);
                return Object::DataType::Float;
        }
    }
