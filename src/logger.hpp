...
namespace Object{
    ...
    #define INFOD(...)			Object::__log_func(__FILE__, __LINE__, Object::LogLevel::Debug, __VA_ARGS__)
    #define INFOV(...)			Object::__log_func(__FILE__, __LINE__, Object::LogLevel::Verbose, __VA_ARGS__)
    #define INFO(...)			Object::__log_func(__FILE__, __LINE__, Object::LogLevel::Info, __VA_ARGS__)
    #define INFOW(...)			Object::__log_func(__FILE__, __LINE__, Object::LogLevel::Warning, __VA_ARGS__)
    #define INFOE(...)			Object::__log_func(__FILE__, __LINE__, Object::LogLevel::Error, __VA_ARGS__)
    #define INFOF(...)			Object::__log_func(__FILE__, __LINE__, Object::LogLevel::Fatal, __VA_ARGS__)
